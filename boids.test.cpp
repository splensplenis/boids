...
TEST_CASE("Testing Boids") {
  ...
  SUBCASE("Testing default initialisation") {
    Vector null_vector{};
    Boid b0{};
    CHECK(b0.position == null_vector);
    CHECK(b0.velocity == null_vector);
  }
}
TEST_CASE("Testing rules") {
  ...
  SUBCASE("Testing get_neighbours_of") {
    ...
    CHECK(is_member(neighbours, b6) == true);
  }
...
TEST_CASE("Testing flock and multiflock classes") {
  ...
  SUBCASE("Testing 3-parameters flock constructor") {
  ...
  SUBCASE("Testing 2-paramerers flock constructor") {
  ...
  SUBCASE("Testing multiflock constructor") {
